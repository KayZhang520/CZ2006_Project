function getReviews() {
  ...
  // var fs = require("fs");
  // var obj = JSON.parse(fs.readFileSync(".\\src\\data\\reviews.json", "utf8"));
  // return [
  //   {
  //     overall: 5.0,
  //     verified: true,
  ...
  //     summary: "Five Stars",
  //     unixReviewTime: 1438732800,
  //   },
  //   {
  //     overall: 5.0,
  //     verified: true,
  //     reviewTime: "04 24, 2015",
  //     reviewerID: "AR3OHHHW01A8E",
  //     asin: "B00009W3PA",
  //     style: { "Size:": " 6-Foot" },
  //     reviewerName: "Calvin E Reames",
  //     reviewText: "Good value for electric dryers",
  //     summary: "Perfect size",
  //     unixReviewTime: 1429833600,
  //   },
  //   {
  //     overall: 5.0,
  //     verified: true,
  //     reviewTime: "03 21, 2015",
  //     reviewerID: "A2CIEGHZ7L1WWR",
  //     asin: "B00009W3PA",
  //     style: { "Size:": " 6-Foot" },
  //     reviewerName: "albert j. kong",
  //     reviewText: "Price and delivery was excellent.",
  //     summary: "Five Stars",
  //     unixReviewTime: 1426896000,
  //   },
  //   {
  //     overall: 5.0,
  //     verified: true,
  //     reviewTime: "12 26, 2013",
  //     reviewerID: "A1RQQV9HYHDHDN",
  //     asin: "B00009W3PA",
  //     style: { "Size:": " 6-Foot" },
  //     reviewerName: "Adam Baer",
  //     reviewText:
  ...
  //     reviewerID: "A1OB2H416ARLFJ",
  //     asin: "B0009GVYNW",
  //     reviewerName: "Commando Big",
  ...
  //     reviewText:
  //       "works great. we loved ours! till we didn't.  these do not last so buy the warranty as you WILL NEED IT.",
  //     summary:
  ...
  //     overall: 1.0,
  //     verified: false,
  //     reviewTime: "11 14, 2014",
  //     reviewerID: "A3SM7H70QI3TY8",
  //     asin: "B000N6302Q",
  //     style: { "Color:": " Orange" },
  //     reviewerName: "SRH",
  //     reviewText:
  ...
  //     reviewText:
  //       'We would give less than 1 star if possible DONT BUY THIS PRODUCT.  The ice machine stopped working four hours after we used it the first time.  We notified New Air and they stated they would not honor their one year warranty because "an authorized dealer didn\'t sell".  We bought this product on Amazon and never even thought we would have to cross check our purchase with the manufacturer.  NewAir does not stand by their products and they will use any method to get out of honoring their warranty.  I have a $200 piece of junk now, I will NEVER buy another NewAir product again.',
  //     summary: "PIECE OF JUNK and NewAir doesn't stand by their products.",
  //     unixReviewTime: 1415923200,
  //   },
  //   {
  //     overall: 5.0,
  ...
  //     asin: "B000NCTOUM",
  //     reviewerName: "Calvin E Reames",
  //     reviewText: "Did the job for fixing our Maytag dryer",
  //     summary: "Works on a Maytag also",
  //     unixReviewTime: 1447200000,
  //   },
  //   {
  //     overall: 2.0,
  //     verified: true,
  //     reviewTime: "08 24, 2015",
  //     reviewerID: "AJPRN1TD1A0SD",
  //     asin: "B000NCTOUM",
  //     reviewerName: "transporter",
  //     reviewText: "cheap",
  //     summary: "Two Stars",
  //     unixReviewTime: 1440374400,
  //   },
  //   {
  //     overall: 5.0,
  //     verified: true,
  //     reviewTime: "01 7, 2015",
  //     reviewerID: "A1AJW9DILZFTQI",
  //     asin: "B000NCTOUM",
  //     reviewerName: "Riteway Appliance",
  //     reviewText: "Great deal and fast shipping!",
  //     summary: "Five Stars",
  //     unixReviewTime: 1420588800,
  //   },
  //   {
  //     overall: 5.0,
  //     verified: true,
  //     reviewTime: "12 3, 2014",
  //     reviewerID: "A11SCLK8GDDN3C",
  //     asin: "B000NCTOUM",
  //     reviewerName: "mrclobhead",
  //     reviewText: "All was fine, product was as advertised.",
  //     summary: "Five Stars",
  ...
  //     overall: 5.0,
  //     verified: true,
  //     reviewTime: "11 21, 2014",
  //     reviewerID: "A1LN48DHHCKLR3",
  //     asin: "B000NCTOUM",
  //     reviewerName: "Ernest Danel",
  //     reviewText: "received ok",
  //     summary: "Five Stars",
  //     unixReviewTime: 1416528000,
  //   },
  //   {
  //     overall: 4.0,
  //     verified: true,
  ...
  //     reviewerName: "James. Backus",
  //     reviewText:
  //       "A spare thermofuse.  Two years ago my dryer spun but there was no heat.  I got a service tech undid the back and changed it in seconds.  So I decided for the price I ordered a spare just in case.",
  //     summary: "A spare thermofuse. Two years ago my dryer spun ...",
  //     unixReviewTime: 1409356800,
  //   },
  //   {
  //     overall: 5.0,
  //     vote: "7",
  ...
  //     summary: "Helping get another season out of humidifier",
  ...
  //     summary: "grate scratches so easily",
  ...
  //     reviewerName: "Bilbo",
  //     reviewText:
  //       "Consider the wisdom of spending a lot of money on replacement parts for a 10+ year old washer that you originally bought for $400. This is one of the cheaper parts so I could see getting this one (and maybe the agitator dogs and motor couplings).  If you're having problems with your motor/clutch/timer or other electrical part, you might want to think about getting another top loader like an Amana before they stop carrying them in stores in about a year or so...",
  //     summary: "Works well as a replacement, if that's what you want to do...",
  //     unixReviewTime: 1388016000,
  //   },
  //   {
  //     overall: 1.0,
  ...
  //     reviewerID: "A2HDUVKXR5CM7H",
  //     asin: "B000XXWOGW",
  //     reviewerName: "MIKE",
  //     reviewText:
  //       "see original remarks, made the mistake of buying it again from same dealer same problems different machine.  Save your money !!",
  //     summary: "garbage",
  ...
  //     reviewerID: "A1HWFUO5PKB2RW",
  //     asin: "B000XXYUSM",
  //     reviewerName: "Greg bernal",
  //     reviewText: "they ok parts",
  //     summary: "Three Stars",
